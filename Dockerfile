# HuggingMes - root Dockerfile for GitHub-connected Hugging Face Spaces.
#
# The one-click desktop deployer uploads the contents of hermes-agent-space/
# directly to HF. When this whole repository is connected to a Space from
# GitHub, HF builds from the repository root instead. Keep this file in sync
# with hermes-agent-space/Dockerfile, but copy files from the subdirectory.
